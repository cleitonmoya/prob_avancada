...
% Notação de vetores, v.a., matrizes e vetpres aleatórios
\newcommand{\vect}[1]{\mathbf{#1}}  	% Vetor não aleatório.
\newcommand{\matr}[1]{\mathbf{#1}}  	% Matriz
...
\newcommand{\Ree}{\widebar{\mathbb{R}}}
\renewcommand{\P}{\mathbb{P}}
\newcommand{\E}{\mathbb{E}}
\newcommand{\Q}{\mathcal{Q}}
\newcommand{\N}{\mathbb{N}}
\newcommand{\Bo}{\mathcal{B}(\Re)} 				% sigma-álgebra de Borel em R
\newcommand{\Born}{\mathcal{B}(\Re^n)} 			% sigma-álgebra de Borel em R^n
...
\newcommand{\toP}{\xrightarrow{\mathcal{P}}}
\newcommand{\toL}{\xrightarrow{L^p}}
\newcommand{\toD}{\xrightarrow{\mathcal{D}}}
\makeatletter
\newcommand{\widebar}[1]{\mathop{\overline{#1}}\@ifnextchar^{}{\,}}
\makeatother
...
\title{Formulário para Probabilidade Avançada}
